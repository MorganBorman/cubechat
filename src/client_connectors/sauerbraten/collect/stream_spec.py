...
stream_spec.add_message_type(message_types.N_TEAMINFO, mt)
...
stream_spec.add_message_type(message_types.N_INITTOKENS, mt)

mt = MessageType("N_TAKETOKEN",
        Field(name="clientnum", type="int"),
        Field(name="token", type="int"),
        Field(name="total", type="int"))
stream_spec.add_message_type(message_types.N_TAKETOKEN, mt)
...
mt = MessageType("N_EXPIRETOKENS",
        TerminatedFieldCollection(name="tokens",
            ...
            field_collection=FieldCollection(
                                         Field(name="token", type="int"))))
stream_spec.add_message_type(message_types.N_EXPIRETOKENS, mt)
...
mt = MessageType("N_DROPTOKENS",
        ...
        TerminatedFieldCollection(name="tokens",
            ...
            field_collection=FieldCollection(
                                         ...
                                         Field(name="team", type="int"),
                                         Field(name="yaw", type="int"))))
stream_spec.add_message_type(message_types.N_DROPTOKENS, mt)
...
mt = MessageType("N_STEALTOKENS",
        ...
        TerminatedFieldCollection(name="tokens",
            ...
            field_collection=FieldCollection(
                                         ...
                                         Field(name="team", type="int"),
                                         Field(name="yaw", type="int"))))
stream_spec.add_message_type(message_types.N_STEALTOKENS, mt)
...
mt = MessageType("N_DEPOSITTOKENS",
        ...
        Field(name="score", type="int"),
        Field(name="flags", type="int"))
stream_spec.add_message_type(message_types.N_DEPOSITTOKENS, mt)
